module TicTacToe
  class Board
    ...
    # On inverse la structure des coordonnées pour les bêtes humains non-dev
    def get_cell(x, y)
      grid[y][x]
    end
    ...
    # On détermine les positions gagnantes
    def winning_positions
      grid + # ligne
      grid.transpose + # colonnes
      diagonals # deux diagonales
    end
    # Onindique au programme ce qu'est une diagonale (il connait ligne et colonne)
    def diagonals
      [
